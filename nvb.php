...
include 'admin_header.php'; 
  $sql= "SELECT * FROM blog where is_verified = '0' && is_deleted = '0'";
...
<div class="container">
  ...
  <tbody class="table-group-divider">
    <tr>
      ...
      <td>
        <a href="db.php?Nvbverify=<?php echo $row['bid']; ?>" class="btn btn-success"> Verify</a>
        <a href="db.php?bedit=<?php echo $row['bid']; ?>" class="btn btn-warning"> Edit</a>
        <a href="db.php?Nvbdelete=<?php echo $row['bid']; ?>" class="btn btn-danger"> Delete</a>
